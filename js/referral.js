/**
 * referral.js - Pure Animation Display (Updated for simple 6-char code)
...
(function() {
    ...
    // ========== PER-CHARACTER ANIMATION (UPDATED: full A-Z0-9 for all positions) ==========
    async function animateCode(container, finalCode) {
        if (!container) return;

        const allChars = 'ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789';
        const charSets = [allChars, allChars, allChars, allChars, allChars, allChars];
    ...
    function init() {
        setupDropdown();
        console.log('✅ Referral animation display ready (no generation, full A-Z0-9)');
    }
